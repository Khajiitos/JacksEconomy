...
public abstract class TransactionMachineMenu extends AbstractContainerMenu implements IBlockEntityContainer<TransactionMachineBlockEntity> {
    private final TransactionMachineBlockEntity blockEntity;

    protected TransactionMachineMenu(@Nullable MenuType<?> pMenuType, int pContainerId, TransactionMachineBlockEntity blockEntity) {
    ...
    public TransactionMachineBlockEntity getBlockEntity() {
